...
$html .= '<table width="' . $ancho . 'px;" height="' . $altura . 'px;"  style="font-size:25px; margin-top:10px; " align="center" cellpadding="4" cellspacing="0"> 
        	<tr>
...
<table width="' . $ancho . 'px;" height="' . $altura . 'px;"  style="font-size:26px;" align="center" cellpadding="4" cellspacing="0" border="0">
  ...
  <tr>
    <td  valign="top" align="left"><b>AGENCIA: ' . $Agent[0] . ' - ' . strtoupper(Remplazar($Agencia[0])) . '</b></td>
