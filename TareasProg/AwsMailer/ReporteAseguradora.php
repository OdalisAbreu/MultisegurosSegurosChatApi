...
function enviarEmailHtml($dist_id)
{
	...
	// $mail = new PHPMailer;
	// $mail->isSMTP();
	// $mail->Host = 'seguroschat.com';
	// $mail->SMTPAuth = true;
	// $mail->Username = 'operaciones@seguroschat.com';
	// $mail->Password = '@x43RMcKh9@L';
	// $mail->SMTPSecure = 'ssl';
	// $mail->From = '	operaciones@seguroschat.com';
	...
	$archivo1 = '/ws_dev/TareasProg/Excel/ASEGURADORA/' . $dist_id . '/MS_RDV_' . $fechasd . '.xls';
