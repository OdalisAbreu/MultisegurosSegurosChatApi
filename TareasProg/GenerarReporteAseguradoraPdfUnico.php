...
$tarifa = explode("/", TarifaVehiculo($RQVehi['veh_tipo'], $id_aseguradora));
...
$html .=
  ...
  <tr>
  <td colspan="2" align="right" height="15" style="font-size:30px">
...
<tr> 
  <td align="left" style="font-size:25px;">
    <strong>Atención al cliente: ' . $contacto . '</strong>
  </td> 
</tr>
<tr>
...
if ($html !== '0') {
  ...
  if (file_exists($dir)) { ?>
    ...
    <a href="javascript:void(0)" style="padding: 10px; display: block; text-align: center; background-color: #65A30D; 
                                        margin-right: 25px; color: white; border-radius: 25px; font-size: 20px;" onclick="location.replace('../../ws_dev/TareasProg/DescargarUnico.php?archivo=<?= $nombreFile ?>');"><b>Descargar Poliza</b></a>
...
$linkPdfPoliza =
  "https://multiseguros.com.do/ws_dev/TareasProg/GenerarReporteAseguradoraPdfUnico.php?sms=0&id_trans=" .
  $row["id"];

$urlSMS = "https://apitellit.aldeamo.com/SmsiWS/smsSendPost/";
